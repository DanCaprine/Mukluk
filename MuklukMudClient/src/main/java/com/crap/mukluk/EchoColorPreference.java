...
public class EchoColorPreference extends Preference {
	...
	public EchoColorPreference(Context context, AttributeSet attrs) 
	{
		super(context, attrs);
		init(attrs);
	}
		 
	public EchoColorPreference(Context context, AttributeSet attrs, int defStyle) 
	{
	...
	public View onCreateView(ViewGroup parent)
	{
		...
		int colorVal = prefs.getInt(getKey(), defaultEchoColor);
